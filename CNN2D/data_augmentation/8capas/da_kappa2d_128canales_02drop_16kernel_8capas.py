...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d/da_kappa2d_02drop128canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('da_kappa2d_128canales_02drop_16kernel_8capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa 2d data augmentation: 16 canales, 0.2 dropout, 16 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d/da_kappa2d_02drop16canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('da_kappa2d_16canales_02drop_16kernel_8capas.ipynb')
experiment.end()

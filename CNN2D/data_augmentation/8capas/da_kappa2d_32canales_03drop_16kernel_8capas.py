...
experiment.set_name("Kappa 2d data augmentation: 32 canales, 0.3 dropout, 16 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d/da_kappa2d_03drop32canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('da_kappa2d_32canales_03drop_16kernel_8capas.ipynb')
experiment.end()

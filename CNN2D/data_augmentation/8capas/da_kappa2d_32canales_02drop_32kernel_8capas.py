...
experiment.set_name("Kappa 2d: 32 canales, 0.2 dropout, 32 kernel, 8 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer3 = nn.Sequential(
            nn.Conv2d(in_channels = 8, out_channels = 12, kernel_size = (1,32), stride= (1,2)) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv2d(in_channels = 12, out_channels = 16, kernel_size = (1, 32), stride= (1,2)) ,
        ...
        self.layer5 = nn.Sequential(
            nn.Conv2d(in_channels = 16, out_channels = 20, kernel_size = (1, 32), stride= (1,2)) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv2d(in_channels = 20, out_channels = 24, kernel_size = (1, 32), stride= (1,2)) ,
        ...
        self.layer7 = nn.Sequential(
            nn.Conv2d(in_channels = 24, out_channels = 28, kernel_size = (1, 32), stride= (1,2)) ,
        ...
        self.layer8 = nn.Sequential(
            nn.Conv2d(in_channels = 28, out_channels = 32, kernel_size = (1, 32), stride= (1,2)) ,
        ...
        self.lin = nn.Linear(in_features = 32* 2* 15, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d/da_kappa2d_02drop32canales32kernel8capas.pth')


# In[ ]:


experiment.log_notebook('da_kappa2d_32canales_02drop_32kernel_8capas.ipynb')
experiment.end()

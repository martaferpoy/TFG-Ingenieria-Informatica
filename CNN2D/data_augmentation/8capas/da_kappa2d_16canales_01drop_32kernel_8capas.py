...
experiment.set_name("Kappa 2d data augmentation: 16 canales, 0.1 dropout, 32 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d/da_kappa2d_01drop16canales32kernel8capas.pth')


# In[ ]:


experiment.log_notebook('da_kappa2d_16canales_01drop_32kernel_8capas.ipynb')
experiment.end()

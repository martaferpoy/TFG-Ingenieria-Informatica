...
experiment.set_name("Kappa 2d data augmentation: 16 canales, 0.4 dropout, 16 kernel, 8 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(in_channels = 1, out_channels = 2, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.layer2 = nn.Sequential(
            nn.Conv2d(in_channels = 2, out_channels = 4, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.layer3 = nn.Sequential(
            nn.Conv2d(in_channels = 4, out_channels = 6, kernel_size = (1,16), stride= (1,2)) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv2d(in_channels = 6, out_channels = 8, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.layer5 = nn.Sequential(
            nn.Conv2d(in_channels = 8, out_channels = 10, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv2d(in_channels = 10, out_channels = 12, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.layer7 = nn.Sequential(
            nn.Conv2d(in_channels = 12, out_channels = 14, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.layer8 = nn.Sequential(
            nn.Conv2d(in_channels = 14, out_channels = 16, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.lin = nn.Linear(in_features = 16* 2* 30, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d/da_kappa2d_04drop16canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('da_kappa2d_16canales_04drop_16kernel_8capas.ipynb')
experiment.end()

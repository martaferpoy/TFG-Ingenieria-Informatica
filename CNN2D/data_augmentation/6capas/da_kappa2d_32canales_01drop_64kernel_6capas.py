...
experiment.set_name("Kappa 2d data augmentation: 32 canales, 0.1 dropout, 64 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer5 = nn.Sequential(
            nn.Conv2d(in_channels = 10, out_channels = 16, kernel_size = (1, 32), stride= (1,2)) ,
        ...
        self.lin = nn.Linear(in_features = 32* 2* 124, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d/da_kappa2d_01drop32canales64kernel6capas.pth')


# In[104]:


experiment.log_notebook('da_kappa2d_32canales_01drop_64kernel_6capas.ipynb')
experiment.end()

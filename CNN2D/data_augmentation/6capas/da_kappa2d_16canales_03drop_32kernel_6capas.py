...
experiment.set_name("Kappa 2d data augmentation: 16 canales, 0.3 dropout, 32 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.lin = nn.Linear(in_features = 16* 2* 156, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d/da_kappa2d_03drop16canales32kernel6capas.pth')


# In[ ]:


experiment.log_notebook('da_kappa2d_16canales_03drop_32kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa 2d data augmentation: 64 canales, 0.2 dropout, 32 kernel, 6 capas")
...
class MyModel(nn.Module):
    def __init__(self):
        ...
        self.lin = nn.Linear(in_features = 64* 2* 156, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d/da_kappa2d_02drop64canales32kernel6capas.pth')


# In[104]:


experiment.log_notebook('da_kappa2d_64canales_02drop_32kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa 2d data augmentation: 16 canales, 0.3 dropout, 128 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer4 = nn.Sequential(
            nn.Conv2d(in_channels = 8, out_channels = 10, kernel_size = (1, 128), stride= (1,2)) ,
        ...
        self.layer5 = nn.Sequential(
            nn.Conv2d(in_channels = 10, out_channels = 12, kernel_size = (1, 128), stride= (1,2)) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv2d(in_channels = 12, out_channels = 16, kernel_size = (1, 128), stride= (1,2)) ,
        ...
        self.lin = nn.Linear(in_features = 16* 2* 61, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d/da_kappa2d_03drop16canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('da_kappa2d_16canales_03drop_128kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa 2d data augmentation: 16 canales, 0.2 dropout, 32 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d/da_kappa2d_02drop16canales32kernel6capas.pth')


# In[ ]:


experiment.log_notebook('da_kappa2d_16canales_02drop_32kernel_6capas.ipynb')
experiment.end()

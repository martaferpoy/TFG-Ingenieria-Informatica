...
experiment.set_name("Kappa 2d data augmentation: 64 canales, 0.2 dropout, 128 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d/da_kappa2d_02drop64canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('da_kappa2d_64canales_02drop_128kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa 2d data augmentation all Hypo: 64 canales, 0.1 dropout, 16 kernel, 8 capas")
...
y_events_file_t = open('C:/Users/GIB/Documents/Marta/y_hypo_aug_train_all.pkl', 'rb')
...
y_events_file_v = open('C:/Users/GIB/Documents/Marta/y_hypo_aug_validation_all.pkl', 'rb')
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d_all/pruebaHypo_da_kappa2d_all_01drop64canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('pruebaHypo_da_kappa2d_all_64canales_01drop_16kernel_8capas.ipynb')
experiment.end()

...
experiment = Experiment(
    ...
    project_name="data-aug-all-cnn2d-kappa-apnea-regression",
    workspace="martaferpoy",
)
experiment.set_name("Kappa 2d data augmentation all Central: 64 canales, 0.1 dropout, 16 kernel, 8 capas")
...
x_file_t = open('C:/Users/GIB/Documents/Marta/x_aug_train_all.pkl', 'rb')
X_train = pickle.load(x_file_t)

y_events_file_t = open('C:/Users/GIB/Documents/Marta/y_central_aug_train_all.pkl', 'rb')
y_events_train = pickle.load(y_events_file_t)

pacient_name_file_t = open('C:/Users/GIB/Documents/Marta/pacient_name_aug_train_all.pkl', 'rb')
names_train = pickle.load(pacient_name_file_t)


x_file_v = open('C:/Users/GIB/Documents/Marta/x_aug_validation_all.pkl', 'rb')
X_validation = pickle.load(x_file_v)

y_events_file_v = open('C:/Users/GIB/Documents/Marta/y_central_aug_validation_all.pkl', 'rb')
y_events_validation = pickle.load(y_events_file_v)

pacient_name_file_v = open('C:/Users/GIB/Documents/Marta/pacient_name_aug_validation_all.pkl', 'rb')
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(in_channels = 1, out_channels = 8, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.layer2 = nn.Sequential(
            nn.Conv2d(in_channels = 8, out_channels = 16, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.layer3 = nn.Sequential(
            nn.Conv2d(in_channels = 16, out_channels = 24, kernel_size = (1,16), stride= (1,2)) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv2d(in_channels = 24, out_channels = 32, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.layer5 = nn.Sequential(
            nn.Conv2d(in_channels = 32, out_channels = 40, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv2d(in_channels = 40, out_channels = 48, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.layer7 = nn.Sequential(
            nn.Conv2d(in_channels = 48, out_channels = 56, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.layer8 = nn.Sequential(
            nn.Conv2d(in_channels = 56, out_channels = 64, kernel_size = (1, 16), stride= (1,2)) ,
        ...
        self.lin = nn.Linear(in_features = 64* 2* 30, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d_all/pruebaCentral_da_kappa2d_all_01drop64canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('pruebaCentral_da_kappa2d_all_64canales_01drop_16kernel_8capas.ipynb')
experiment.end()

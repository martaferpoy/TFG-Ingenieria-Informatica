...
experiment = Experiment(
    ...
    project_name="cnn2d-ridge-kappa-apnea-regression",
    workspace="martaferpoy",
)
experiment.set_name("Kappa 2d ridge Central: 64 canales, 0.1 dropout, 16 kernel, 8 capas")
...
y_events_file_t = open('C:/Users/GIB/Documents/Marta/y_central_train.pkl', 'rb')
...
y_events_file_v = open('C:/Users/GIB/Documents/Marta/y_central_validation.pkl', 'rb')
...
optimizer = torch.optim.Adam(model.parameters(), lr=hiperparametros['lr'], weight_decay = 10e-5)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d_ridge/pruebaCentral_kappa2d_ridge01drop64canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('pruebaCentral_kappa2d_ridge_64canales_01drop_16kernel_8capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa 2d data augmentation ridge Hypo: 128 canales, 0.2 dropout, 32 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/pruebaHypo_da_kappa2d_ridge/da_kappa2d_ridge02drop128canales32kernel6capas.pth')


# In[104]:


experiment.log_notebook('pruebaHypo_da_kappa2d_ridge_128canales_02drop_32kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa 2d Hypo: 128 canales, 0.2 dropout, 32 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/pruebaHypo_kappa2d_02drop128canales32kernel6capas.pth')


# In[104]:


experiment.log_notebook('pruebaHypo_kappa2d_128canales_02drop_32kernel_6capas.ipynb')
experiment.end()

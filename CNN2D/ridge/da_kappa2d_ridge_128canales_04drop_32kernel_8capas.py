...
experiment.set_name("Kappa 2d data augmentation ridge: 128 canales, 0.4 dropout, 32 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d_ridge/da_kappa2d_ridge04drop128canales32kernel8capas.pth')


# In[104]:


experiment.log_notebook('da_kappa2d_ridge_128canales_04drop_32kernel_8capas.ipynb')
experiment.end()

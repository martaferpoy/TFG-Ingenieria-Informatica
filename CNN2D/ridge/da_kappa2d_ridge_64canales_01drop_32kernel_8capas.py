...
experiment.set_name("Kappa 2d data augmentation ridge: 64 canales, 0.1 dropout, 32 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d_ridge/da_kappa2d_ridge01drop64canales32kernel8capas.pth')


# In[104]:


experiment.log_notebook('da_kappa2d_ridge_64canales_01drop_32kernel_8capas.ipynb')
experiment.end()

...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d_ridge/kappa2d_ridge02drop128canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa2d_ridge_128canales_02drop_16kernel_8capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa 2d: 64 canales, 0.1 dropout, 128 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer2 = nn.Sequential(
            nn.Conv2d(in_channels = 4, out_channels = 6, kernel_size = (1, 128), stride= (1,2)) ,
        ...
        self.layer3 = nn.Sequential(
            nn.Conv2d(in_channels = 6, out_channels = 8, kernel_size = (1,128), stride= (1,2)) ,
        ...
        self.lin = nn.Linear(in_features = 64* 2* 61, out_features = 1)
...
for epoch in range(hiperparametros['epocas']):
    ...
    # chequeo la metrica (mse) que tengo en esta epoca, y si es mejor que en epocas anteriores, guardo el modelo
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/kappa2d_01drop64canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa2d_64canales_01drop_128kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa 2d: 32 canales, 0.4 dropout, 64 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/kappa2d_04drop32canales64kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa2d_32canales_04drop_64kernel_6capas.ipynb')
experiment.end()

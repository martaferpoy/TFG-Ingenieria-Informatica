...
experiment.set_name("Kappa 2d: 16 canales, 0.3 dropout, 32 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/kappa2d_03drop16canales32kernel6capas.pth')


# In[ ]:


experiment.log_notebook('kappa2d_16canales_03drop_32kernel_6capas.ipynb')
experiment.end()

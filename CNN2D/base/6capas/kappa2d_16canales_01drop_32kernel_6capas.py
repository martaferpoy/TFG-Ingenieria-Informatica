...
experiment.set_name("Kappa 2d: 16 canales, 0.1 dropout, 32 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/kappa2d_01drop16canales32kernel6capas.pth')


# In[ ]:


experiment.log_notebook('kappa2d_16canales_01drop_32kernel_6capas.ipynb')
experiment.end()

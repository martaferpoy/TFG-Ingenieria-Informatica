...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/kappa2d_03drop128canales32kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa2d_128canales_03drop_32kernel_6capas.ipynb')
experiment.end()

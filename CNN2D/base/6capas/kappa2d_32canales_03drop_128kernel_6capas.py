...
experiment.set_name("Kappa 2d: 32 canales, 0.3 dropout, 128 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/kappa2d_03drop32canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa2d_32canales_03drop_128kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa 2d: 128 canales, 0.4 dropout, 128 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/kappa2d_04drop128canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa2d_128canales_04drop_128kernel_6capas.ipynb')
experiment.end()

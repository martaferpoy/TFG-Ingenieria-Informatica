...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/kappa2d_02drop128canales64kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa2d_128canales_02drop_64kernel_6capas.ipynb')
experiment.end()

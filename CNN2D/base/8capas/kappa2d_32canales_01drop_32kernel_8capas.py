...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/kappa2d_01drop32canales32kernel8capas.pth')


# In[ ]:


experiment.log_notebook('kappa2d_32canales_01drop_32kernel_8capas.ipynb')
experiment.end()

...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/kappa2d_04drop128canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa2d_128canales_04drop_16kernel_8capas.ipynb')
experiment.end()

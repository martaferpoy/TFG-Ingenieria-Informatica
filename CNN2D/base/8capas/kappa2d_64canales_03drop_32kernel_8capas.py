...
experiment.set_name("Kappa 2d: 64 canales, 0.3 dropout, 32 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/kappa2d_03drop64canales32kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa2d_64canales_03drop_32kernel_8capas.ipynb')
experiment.end()

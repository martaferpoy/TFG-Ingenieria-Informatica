...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa2d/kappa2d_01drop64canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa2d_64canales_01drop_16kernel_8capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa 2d data augmentation: 18 canales, 0.1 dropout, 128 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(in_channels = 1, out_channels = 4, kernel_size = (1, 128), stride= (1,2)) ,
        ...
        self.layer2 = nn.Sequential(
            nn.Conv2d(in_channels = 4, out_channels = 8, kernel_size = (1, 128), stride= (1,2)) ,
        ...
        self.layer3 = nn.Sequential(
            nn.Conv2d(in_channels = 8, out_channels = 16, kernel_size = (1,128), stride= (1,2)) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv2d(in_channels = 16, out_channels = 32, kernel_size = (1, 128), stride= (1,2)) ,
        ...
        self.layer5 = nn.Sequential(
            nn.Conv2d(in_channels = 32, out_channels = 64, kernel_size = (1, 128), stride= (1,2)) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv2d(in_channels = 64, out_channels = 128, kernel_size = (1, 128), stride= (1,2)) ,
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d_all/da_kappa2d_all_01drop128canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('da_kappa2d_all_128canales_01drop_128kernel_6capas.ipynb')
experiment.end()

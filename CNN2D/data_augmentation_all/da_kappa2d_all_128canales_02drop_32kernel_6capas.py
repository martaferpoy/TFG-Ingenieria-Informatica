...
experiment.set_name("Kappa data augmentation: 128 canales, 0.2 dropout, 32 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa2d_all/da_kappa2d_all_02drop128canales32kernel6capas.pth')


# In[104]:


experiment.log_notebook('da_kappa2d_all_128canales_02drop_32kernel_6capas.ipynb')
experiment.end()

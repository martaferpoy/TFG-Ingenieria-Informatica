...
experiment.set_name("Kappa data augmentation all central: 128 canales, 0.3 dropout, 32 kernel, 8 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv1d(in_channels = 2, out_channels = 16, kernel_size = 32, stride= 2) ,
        ...
        self.layer3 = nn.Sequential(
            nn.Conv1d(in_channels = 32, out_channels = 48, kernel_size = 32, stride= 2) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv1d(in_channels = 48, out_channels = 64, kernel_size = 32, stride= 2) ,
        ...
        self.layer5 = nn.Sequential(
            nn.Conv1d(in_channels = 64, out_channels = 80, kernel_size = 32, stride= 2) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv1d(in_channels = 80, out_channels = 96, kernel_size = 32, stride= 2) ,
        ...
        self.layer7 = nn.Sequential(
            nn.Conv1d(in_channels = 96, out_channels = 112, kernel_size = 32, stride= 2) ,
        ...
        self.layer8 = nn.Sequential(
            nn.Conv1d(in_channels = 112, out_channels = 128, kernel_size = 32, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 128*15, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa_all/pruebaCentral_da_kappa_all_03drop128canales32kernel8capas.pth')


# In[104]:


experiment.log_notebook('pruebaCentral_da_kappa_all_128canales_03drop_32kernel_8capas.ipynb')
experiment.end()

...
experiment = Experiment(
    ...
    project_name="data-aug-all-cnn1d-kappa-apnea-regression",
    workspace="martaferpoy",
)
experiment.set_name("Kappa data augmentation all central: 128 canales, 0.2 dropout, 16 kernel, 8 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv1d(in_channels = 2, out_channels = 16, kernel_size = 16, stride= 2) ,
        ...
        self.layer2 = nn.Sequential(
            nn.Conv1d(in_channels = 16, out_channels = 32, kernel_size = 16, stride= 2) ,
        ...
        self.layer3 = nn.Sequential(
            nn.Conv1d(in_channels = 32, out_channels = 48, kernel_size = 16, stride= 2) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv1d(in_channels = 48, out_channels = 64, kernel_size = 16, stride= 2) ,
        ...
        self.layer5 = nn.Sequential(
            nn.Conv1d(in_channels = 64, out_channels = 80, kernel_size = 16, stride= 2) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv1d(in_channels = 80, out_channels = 96, kernel_size = 16, stride= 2) ,
        ...
        self.layer7 = nn.Sequential(
            nn.Conv1d(in_channels = 96, out_channels = 112, kernel_size = 16, stride= 2) ,
            nn.BatchNorm1d(num_features = 112),
            nn.ReLU(),
            nn.MaxPool1d(kernel_size = 2, stride = 1),
            nn.Dropout(p = hiperparametros['dropout'])
        )
        self.layer8 = nn.Sequential(
            nn.Conv1d(in_channels = 112, out_channels = 128, kernel_size = 16, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 128*30, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa_all/pruebaCentral_da_kappa_all_02drop128canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('pruebaCentral_da_kappa_all_128canales_02drop_16kernel_8capas.ipynb')
experiment.end()

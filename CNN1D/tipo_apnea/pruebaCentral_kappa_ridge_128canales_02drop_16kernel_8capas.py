...
experiment = Experiment(
    ...
    project_name="cnn1d-ridge-kappa-apnea-regression",
    workspace="martaferpoy",
)
experiment.set_name("Kappa ridge Central: 128 canales, 0.2 dropout, 16 kernel, 8 capas")
...
optimizer = torch.optim.Adam(model.parameters(), weight_decay = 10e-5)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa_ridge/pruebaCentral_kappa_ridge02drop128canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('pruebaCentral_kappa_ridge_128canales_02drop_16kernel_8capas.ipynb')
experiment.end()

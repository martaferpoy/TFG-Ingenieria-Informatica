...
experiment.set_name("Kappa data augmentation all OSA: 128 canales, 0.2 dropout, 16 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa_all/pruebaOSA_da_kappa_all_02drop128canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('pruebaOSA_da_kappa_all_128canales_02drop_16kernel_8capas.ipynb')
experiment.end()

...
experiment = Experiment(
    ...
    project_name="cnn1d-kappa-apnea-regression",
    workspace="martaferpoy",
)
experiment.set_name("Kappa prueba central: 128 canales, 0.2 dropout, 16 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_pruebacentral_02drop128canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('pruebacentral_kappa_128canales_02drop_16kernel_8capas.ipynb')
experiment.end()

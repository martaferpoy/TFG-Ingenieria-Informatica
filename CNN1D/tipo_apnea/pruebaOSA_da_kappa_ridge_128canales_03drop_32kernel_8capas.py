...
experiment.set_name("Kappa data augmentation ridge OSA: 128 canales, 0.3 dropout, 32 kernel, 8 capas")
...
y_events_file_t = open('C:/Users/GIB/Documents/Marta/y_osa_aug_train.pkl', 'rb')
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa_ridge/pruebaOSA_da_kappa_ridge03drop128canales32kernel8capas.pth')


# In[104]:


experiment.log_notebook('pruebaOSA_da_kappa_ridge_128canales_03drop_32kernel_8capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa: 64 canales, 0.3 dropout, 32 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_03drop64canales32kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_64canales_03drop_32kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa: 32 canales, 0.1 dropout, 128 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer5 = nn.Sequential(
            nn.Conv1d(in_channels = 16, out_channels = 24, kernel_size = 128, stride= 2) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv1d(in_channels = 24, out_channels = 32, kernel_size = 128, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 32*61, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_01drop32canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_32canales_01drop_128kernel_6capas.ipynb')
experiment.end()

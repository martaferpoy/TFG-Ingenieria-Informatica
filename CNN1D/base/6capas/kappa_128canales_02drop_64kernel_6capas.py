...
experiment.set_name("Kappa: 128 canales, 0.2 dropout, 64 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer3 = nn.Sequential(
            nn.Conv1d(in_channels = 8, out_channels = 16, kernel_size = 64, stride= 2) ,
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_02drop128canales64kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_128canales_02drop_64kernel_6capas.ipynb')
experiment.end()

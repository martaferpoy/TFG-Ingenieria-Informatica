...
experiment.set_name("Kappa: 16 canales, 0.1 dropout, 64 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer2 = nn.Sequential(
            nn.Conv1d(in_channels = 4, out_channels = 6, kernel_size = 64, stride= 2) ,
        ...
        self.layer3 = nn.Sequential(
            nn.Conv1d(in_channels = 6, out_channels = 8, kernel_size = 64, stride= 2) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv1d(in_channels = 8, out_channels = 10, kernel_size = 64, stride= 2) ,
        ...
        self.layer5 = nn.Sequential(
            nn.Conv1d(in_channels = 10, out_channels = 12, kernel_size = 64, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 16*124, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_01drop16canales64kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_16canales_01drop_64kernel_6capas.ipynb')
experiment.end()

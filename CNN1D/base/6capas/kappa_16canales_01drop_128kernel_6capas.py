...
experiment.set_name("Kappa: 16 canales, 0.1 dropout, 128 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_01drop16canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_16canales_01drop_128kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa: 32 canales, 0.4 dropout, 64 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer5 = nn.Sequential(
            nn.Conv1d(in_channels = 16, out_channels = 24, kernel_size = 64, stride= 2) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv1d(in_channels = 24, out_channels = 32, kernel_size = 64, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 32*124, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_04drop32canales64kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_32canales_04drop_64kernel_6capas.ipynb')
experiment.end()

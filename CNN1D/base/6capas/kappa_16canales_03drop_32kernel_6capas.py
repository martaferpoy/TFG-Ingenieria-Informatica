...
experiment.set_name("Kappa: 16 canales, 0.3 dropout, 32 kernel, 6 capas")
...
class MyModel(nn.Module):
    def __init__(self):
        ...
        self.layer2 = nn.Sequential(
            nn.Conv1d(in_channels = 4, out_channels = 6, kernel_size = 32, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 16*156, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_03drop16canales32kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_16canales_03drop_32kernel_6capas.ipynb')
experiment.end()

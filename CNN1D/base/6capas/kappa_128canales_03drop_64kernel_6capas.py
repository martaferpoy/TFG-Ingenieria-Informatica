...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_03drop128canales64kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_128canales_03drop_64kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa: 64 canales, 0.2 dropout, 64 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv1d(in_channels = 2, out_channels = 4, kernel_size = 64, stride= 2) ,
        ...
        self.layer2 = nn.Sequential(
            nn.Conv1d(in_channels = 4, out_channels = 8, kernel_size = 64, stride= 2) ,
        ...
        self.layer3 = nn.Sequential(
            nn.Conv1d(in_channels = 8, out_channels = 12, kernel_size = 64, stride= 2) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv1d(in_channels = 12, out_channels = 16, kernel_size = 64, stride= 2) ,
        ...
        self.layer5 = nn.Sequential(
            nn.Conv1d(in_channels = 16, out_channels = 32, kernel_size = 64, stride= 2) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv1d(in_channels = 32, out_channels = 64, kernel_size = 64, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 64*124, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_02drop64canales64kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_64canales_02drop_64kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa: 64 canales, 0.1 dropout, 64 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_01drop64canales64kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_64canales_01drop_64kernel_6capas.ipynb')
experiment.end()

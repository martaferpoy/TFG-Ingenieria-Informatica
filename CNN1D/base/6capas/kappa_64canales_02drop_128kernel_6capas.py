...
experiment.set_name("Kappa: 64 canales, 0.2 dropout, 128 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer3 = nn.Sequential(
            nn.Conv1d(in_channels = 8, out_channels = 12, kernel_size = 128, stride= 2) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv1d(in_channels = 12, out_channels = 16, kernel_size = 128, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 64*61, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_02drop64canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_64canales_02drop_128kernel_6capas.ipynb')
experiment.end()

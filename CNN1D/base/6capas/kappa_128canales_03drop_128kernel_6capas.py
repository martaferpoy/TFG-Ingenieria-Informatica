...
experiment.set_name("Kappa: 18 canales, 0.3 dropout, 128 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_03drop128canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_128canales_03drop_128kernel_6capas.ipynb')
experiment.end()

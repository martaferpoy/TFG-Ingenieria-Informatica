...
experiment.set_name("Kappa: 16 canales, 0.2 dropout, 128 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_02drop16canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_16canales_02drop_128kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa: 128 canales, 0.2 dropout, 128 kernel, 6 capas")
...
class MyModel(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv1d(in_channels = 2, out_channels = 4, kernel_size = 128, stride= 2) ,
        ...
        self.layer2 = nn.Sequential(
            nn.Conv1d(in_channels = 4, out_channels = 8, kernel_size = 128, stride= 2) ,
        ...
        self.layer3 = nn.Sequential(
            nn.Conv1d(in_channels = 8, out_channels = 16, kernel_size = 128, stride= 2) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv1d(in_channels = 16, out_channels = 32, kernel_size = 128, stride= 2) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv1d(in_channels = 64, out_channels = 128, kernel_size = 128, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 128*61, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_02drop128canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_128canales_02drop_128kernel_6capas.ipynb')
experiment.end()

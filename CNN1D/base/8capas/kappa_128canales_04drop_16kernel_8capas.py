...
experiment.set_name("Kappa: 128 canales, 0.4 dropout, 16 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_04drop128canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa_128canales_04drop_16kernel_8capas.ipynb')
experiment.end()

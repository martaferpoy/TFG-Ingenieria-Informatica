...
experiment.set_name("Kappa: 64 canales, 0.2 dropout, 32 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_02drop64canales32kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa_64canales_02drop_32kernel_8capas.ipynb')
experiment.end()

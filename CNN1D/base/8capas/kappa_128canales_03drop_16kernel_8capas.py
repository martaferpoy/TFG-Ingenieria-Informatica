...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_03drop128canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa_128canales_03drop_16kernel_8capas.ipynb')
experiment.end()

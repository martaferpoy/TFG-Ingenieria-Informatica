...
experiment.set_name("Kappa: 16 canales, 0.3 dropout, 16 kernel, 8 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer2 = nn.Sequential(
            nn.Conv1d(in_channels = 4, out_channels = 5, kernel_size = 16, stride= 2) ,
        ...
        self.layer3 = nn.Sequential(
            nn.Conv1d(in_channels = 5, out_channels = 6, kernel_size = 16, stride= 2) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv1d(in_channels = 6, out_channels = 8, kernel_size = 16, stride= 2) ,
        ...
        self.layer5 = nn.Sequential(
            nn.Conv1d(in_channels = 8, out_channels = 10, kernel_size = 16, stride= 2) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv1d(in_channels = 10, out_channels = 12, kernel_size = 16, stride= 2) ,
        ...
        self.layer7 = nn.Sequential(
            nn.Conv1d(in_channels = 12, out_channels = 14, kernel_size = 16, stride= 2) ,
        ...
        self.layer8 = nn.Sequential(
            nn.Conv1d(in_channels = 14, out_channels = 16, kernel_size = 16, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 16*30, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_03drop16canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa_16canales_03drop_16kernel_8capas.ipynb')
experiment.end()

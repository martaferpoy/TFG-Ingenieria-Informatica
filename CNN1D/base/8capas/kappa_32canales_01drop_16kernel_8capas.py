...
experiment.set_name("Kappa: 32 canales, 0.1 dropout, 16 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_01drop32canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa_32canales_01drop_16kernel_8capas.ipynb')
experiment.end()

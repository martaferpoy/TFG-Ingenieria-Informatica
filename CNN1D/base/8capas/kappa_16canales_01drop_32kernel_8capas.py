...
experiment.set_name("Kappa: 16 canales, 0.1 dropout, 32 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_01drop16canales32kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa_16canales_01drop_32kernel_8capas.ipynb')
experiment.end()

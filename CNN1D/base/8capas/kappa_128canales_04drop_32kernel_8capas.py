...
experiment.set_name("Kappa: 128 canales, 0.4 dropout, 32 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_04drop128canales32kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa_128canales_04drop_32kernel_8capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa: 32 canales, 0.4 dropout, 32 kernel, 8 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer5 = nn.Sequential(
            nn.Conv1d(in_channels = 16, out_channels = 20, kernel_size = 32, stride= 2) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv1d(in_channels = 20, out_channels = 24, kernel_size = 32, stride= 2) ,
        ...
        self.layer7 = nn.Sequential(
            nn.Conv1d(in_channels = 24, out_channels = 28, kernel_size = 32, stride= 2) ,
        ...
        self.layer8 = nn.Sequential(
            nn.Conv1d(in_channels = 28, out_channels = 32, kernel_size = 32, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 32*15, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa/kappa_04drop32canales32kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa_32canales_04drop_32kernel_8capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa data augmentation all: 128 canales, 0.3 dropout, 16 kernel, 8 capas")
...
y_events_file_t = open('C:/Users/GIB/Documents/Marta/y_events_aug_train_all.pkl', 'rb')
...
y_events_file_v = open('C:/Users/GIB/Documents/Marta/y_events_aug_validation_all.pkl', 'rb')
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa_all/da_kappa__all03drop128canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('da_kappa_all_128canales_03drop_16kernel_8capas.ipynb')
experiment.end()

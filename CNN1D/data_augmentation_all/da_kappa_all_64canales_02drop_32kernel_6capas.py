...
experiment.set_name("Kappa data augmentation: 64 canales, 0.2 dropout, 32 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer3 = nn.Sequential(
            nn.Conv1d(in_channels = 8, out_channels = 12, kernel_size = 32, stride= 2) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv1d(in_channels = 12, out_channels = 16, kernel_size = 32, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 64*156, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa_all/da_kappa_all_02drop64canales32kernel6capas.pth')


# In[104]:


experiment.log_notebook('da_kappa_all_64canales_02drop_32kernel_6capas.ipynb')
experiment.end()

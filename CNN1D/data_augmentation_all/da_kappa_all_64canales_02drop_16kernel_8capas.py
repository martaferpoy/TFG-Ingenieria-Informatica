...
experiment.set_name("Kappa data augmentation: 64 canales, 0.2 dropout, 16 kernel, 8 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv1d(in_channels = 2, out_channels = 8, kernel_size = 16, stride= 2) ,
        ...
        self.layer2 = nn.Sequential(
            nn.Conv1d(in_channels = 8, out_channels = 16, kernel_size = 16, stride= 2) ,
        ...
        self.layer3 = nn.Sequential(
            nn.Conv1d(in_channels = 16, out_channels = 24, kernel_size = 16, stride= 2) ,
        ...
        self.layer4 = nn.Sequential(
            nn.Conv1d(in_channels = 24, out_channels = 32, kernel_size = 16, stride= 2) ,
        ...
        self.layer5 = nn.Sequential(
            nn.Conv1d(in_channels = 32, out_channels = 40, kernel_size = 16, stride= 2) ,
        ...
        self.layer6 = nn.Sequential(
            nn.Conv1d(in_channels = 40, out_channels = 48, kernel_size = 16, stride= 2) ,
        ...
        self.layer7 = nn.Sequential(
            nn.Conv1d(in_channels = 48, out_channels = 56, kernel_size = 16, stride= 2) ,
        ...
        self.layer8 = nn.Sequential(
            nn.Conv1d(in_channels = 56, out_channels = 64, kernel_size = 16, stride= 2) ,
        ...
        self.lin = nn.Linear(in_features = 64*30, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa_all/da_kappa_all_02drop64canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('da_kappa_all_64canales_02drop_16kernel_8capas.ipynb')
experiment.end()

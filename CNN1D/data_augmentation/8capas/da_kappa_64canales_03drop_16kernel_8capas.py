...
experiment.set_name("Kappa data augmentation: 64 canales, 0.3 dropout, 16 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa/da_kappa_03drop64canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('da_kappa_64canales_03drop_16kernel_8capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa data augmentation: 128 canales, 0.3 dropout, 128 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa/da_kappa_03drop128canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('da_kappa_128canales_03drop_128kernel_6capas.ipynb')
experiment.end()

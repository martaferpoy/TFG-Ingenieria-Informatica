...
experiment.set_name("Kappa data augmentation: 64 canales, 0.2 dropout, 64 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa/da_kappa_02drop64canales64kernel6capas.pth')


# In[104]:


experiment.log_notebook('da_kappa_64canales_02drop_64kernel_6capas.ipynb')
experiment.end()

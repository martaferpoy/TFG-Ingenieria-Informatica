...
experiment.set_name("Kappa data augmentation: 16 canales, 0.4 dropout, 32 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa/da_kappa_04drop16canales32kernel6capas.pth')


# In[104]:


experiment.log_notebook('da_kappa_16canales_04drop_32kernel_6capas.ipynb')
experiment.end()

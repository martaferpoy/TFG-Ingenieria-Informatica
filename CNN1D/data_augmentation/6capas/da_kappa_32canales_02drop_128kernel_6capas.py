...
experiment.set_name("Kappa data augmentation: 32 canales, 0.2 dropout, 128 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa/da_kappa_02drop32canales128kernel6capas.pth')


# In[104]:


experiment.log_notebook('da_kappa_32canales_02drop_128kernel_6capas.ipynb')
experiment.end()

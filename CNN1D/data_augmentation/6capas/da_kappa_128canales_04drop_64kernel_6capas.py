...
experiment.set_name("Kappa data augmentation: 128 canales, 0.4 dropout, 64 kernel, 6 capas")
...
class MyModel(nn.Module): 
    def __init__(self):
        ...
        self.lin = nn.Linear(in_features = 128*124, out_features = 1)
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/da_kappa/da_kappa_04drop128canales64kernel6capas.pth')


# In[104]:


experiment.log_notebook('da_kappa_128canales_04drop_64kernel_6capas.ipynb')
experiment.end()

...
experiment.set_name("Kappa ridge: 64 canales, 0.2 dropout, 32 kernel, 6 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa_ridge/kappa_ridge02drop64canales32kernel6capas.pth')


# In[104]:


experiment.log_notebook('kappa_ridge_64canales_02drop_32kernel_6capas.ipynb')
experiment.end()

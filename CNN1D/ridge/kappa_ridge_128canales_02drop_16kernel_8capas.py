...
experiment.set_name("Kappa ridge: 128 canales, 0.2 dropout, 16 kernel, 8 capas")
...
torch.save(best_model.state_dict(), 'C:/Users/GIB/Documents/Marta/trained_models/kappa_ridge/kappa_ridge02drop128canales16kernel8capas.pth')


# In[104]:


experiment.log_notebook('kappa_ridge_128canales_02drop_16kernel_8capas.ipynb')
experiment.end()
